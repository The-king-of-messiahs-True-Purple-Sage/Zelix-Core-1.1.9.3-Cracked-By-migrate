...
import zelix.gui.clickguis.Astolfo.ClickGui.ColorValueButton;
import zelix.gui.clickguis.Astolfo.ClickGui.KeyBindButton;
...
public class Button {
    ...
    public Button(HackCategory category, Hack cheat, int x, int y) {
    ...
    public void render(int mouseX, int mouseY, Limitation limitation) {
        ...
        GL11.glPopMatrix();
        if (this.expand) {
            this.buttons.forEach(component2 -> component2.render(mouseX, mouseY, limitation));
        }
    }
