...
extends Component {
    ...
    public VisibleButton(Button button, Hack mod, int offset) {
        this.parent = button;
        this.mod = mod;
    ...
    public void renderComponent() {
        ...
        Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow("Visible: " + this.mod.isShow(), (float)((this.parent.parent.getX() + 7) * 2), (float)((this.parent.parent.getY() + this.offset + 2) * 2 + 5), -1);
        GL11.glPopMatrix();
    }
